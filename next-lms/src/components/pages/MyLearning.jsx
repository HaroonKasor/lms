...
// --- Course Card ---
function CourseCard({ enrollment, formatDuration }) {
                    ...
                    >
                        ...
                        <div className="h-[62vh] min-h-[420px] max-h-[620px] flex items-center justify-center">
                            <img
                                ...
                                className="max-w-full max-h-full w-auto h-auto object-contain mx-auto border border-[#E5EAF8]"
                            />
                        </div>
                        ...
                        <div className="flex justify-end mt-6">
                            <a
                                ...
                                download={`certificate-${course?.id || 'mockup'}.jpg`}
