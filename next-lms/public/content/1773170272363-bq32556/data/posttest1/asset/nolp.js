...
//	document.write("<span id=skin style='position:absolute;left:410px;top:605px;z-index:999999'><span onclick=\"javascript: nolpifrm.showhide('66')\" style=\"cursor: pointer;\"><IMG SRC=\"asset/prev.gif\" BORDER=\"0\" align=\"middle\"  title=\"ย้อนกลับ\" width=30 height=30></span>&nbsp;&nbsp;<span id=skin style='z-index:3;color:#FFFFFF;font-size: 16px;padding:10px 20px 10px 20px;font-family:arial;line-height:30px;position:relative;top:5px;'><B>ข้อที่ <span id='numchoice'>1</span>/10</B></span>&nbsp;&nbsp;<span onclick=\"javascript: nolpifrm.showhide('99')\" style=\"cursor: pointer;\"><IMG SRC=\"asset/next.gif\" BORDER=\"0\" align=\"middle\" title=\"ถัดไป\" width=30 height=30></span></span>");
	document.write("</div>");
